...
If your YugabyteDB instance is located in the Cloud at Amazon Web Services RDS for example or Microsoft Azure, your preferred access to your instance will be over SSH through port 22.
...
![Reverse-engineering PostgreSQL - SSH w Private Key](<lib/RE - MongoDB - SSH w Private Key.png>)
...
![Reverse-engineering PostgreSQL - SSH w Password](<lib/RE - MongoDB - SSH w Password.png>)
