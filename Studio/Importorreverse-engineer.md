...
* a diagram generated with other tools, including GenAI: in [DBML syntax](<GenAI-createdDBML.md>) or [Mermaid ER code](<GenAI-createdMermaidERdiagram.md>)
* a [PowerDesigner](<PowerDesigner.md>) file: conceptual (.cdm), logical (.ldm), or physical (.pdm) data model
* an [XSD schema](<XSDXMLSchemaDefinition.md>) file from another ER tool, such as erwin, ER/Studio, or other
