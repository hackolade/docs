...
You may also [view this tutorial](<https://community.hackolade.com/slides/slide/leverage-a-polyglot-data-model-23> "target=\"\_blank\"") on YouTube.&nbsp; Summary slides can be found [here](<https://www.slideshare.net/PascalDesmarets1/hackolade-tutorial-part-13-leverage-a-polyglot-data-model> "target=\"\_blank\"").
